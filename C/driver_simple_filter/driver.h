...
NTSTATUS my_ioctl_push(PIRP Irp, PIO_STACK_LOCATION pIoStackIrp, UINT* dataSize);
NTSTATUS my_ioctl_pop(PIRP Irp, PIO_STACK_LOCATION pIoStackIrp, UINT* dataSize);
